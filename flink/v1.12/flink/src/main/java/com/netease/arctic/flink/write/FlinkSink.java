...
public class FlinkSink {
  ...
  public static class Builder {
    ...
    public DataStreamSink<?> build() {
      ...
      if (shufflePolicy != null) {
        rowDataInput = rowDataInput.partitionCustom(shufflePolicy.generatePartitioner(),
    ...
    private DistributionHashMode getDistributionHashMode() {
      ...
      String modeName = PropertyUtil.propertyAsString(table.properties(),
  ...
  public static ArcticFileWriter createFileWriter(ArcticTable arcticTable,
    ...
    LOG.info("with maxOpenFilesSizeBytes = {}MB, close biggest/earliest file to avoid OOM",
